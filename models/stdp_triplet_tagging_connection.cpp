/*
 *  stdp_triplet_tagging_connection.cpp
 *
...
{
//
// Implementation of class STDPTripletTaggingCommonProperties.
//

STDPTripletTaggingCommonProperties::STDPTripletTaggingCommonProperties()
...
void
STDPTripletTaggingCommonProperties::get_status( DictionaryDatum& d ) const
{
...
void
STDPTripletTaggingCommonProperties::set_status( const DictionaryDatum& d,
  ConnectorModel& cm )
{
...
Node*
STDPTripletTaggingCommonProperties::get_node()
{
  if ( vt_ == 0 )
    throw BadProperty(
