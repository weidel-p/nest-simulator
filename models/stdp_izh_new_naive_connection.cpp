/*
 *  stdp_izh_new_naive_connection.cpp
 *
...
#include "stdp_izh_new_naive_connection.h"
...
STDPIzhNewNaiveConnection::STDPIzhNewNaiveConnection()
  : ConnectionBase()
  , weight_(1.0)
  , wdev_(0.0)
  , K_plus_(0.0)
...
STDPIzhNewNaiveConnection::STDPIzhNewNaiveConnection( const STDPIzhNewNaiveConnection& rhs )
  : ConnectionBase( rhs )
  , weight_( rhs.weight_ )
  , wdev_( rhs.wdev_ )
  , K_plus_( rhs.K_plus_ )
...
void
STDPIzhNewNaiveConnection::get_status( DictionaryDatum& d ) const
{
...
void
STDPIzhNewNaiveConnection::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
