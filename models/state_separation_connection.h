...
public:
  ...
  double_t tau_n_;
  double_t b_;
  double_t n_upper_threshold_;
  double_t n_lower_threshold_;
  double_t mean_firing_rate_;
  double_t Wmin_;
  double_t Wmax_;
};
  ...
  ConnectorModel& cm )
{
  ...
  updateValue< double_t >( d, "Kminus", Kminus_);
}
...
StateSeparationConnection< targetidentifierT >::update_weight_( 
  ...
  const StateSeparationCommonProperties& cp )
{
//double_t kminus = get_target(0)->get_K_value( t1 - get_delay());
