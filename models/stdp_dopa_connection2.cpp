...
{
//
// Implementation of class STDPDopa2CommonProperties.
//

STDPDopa2CommonProperties::STDPDopa2CommonProperties()
...
void
STDPDopa2CommonProperties::get_status( DictionaryDatum& d ) const
{
...
void
STDPDopa2CommonProperties::set_status( const DictionaryDatum& d,
  ConnectorModel& cm )
{
  ...
  {
    vt_ = dynamic_cast< volume_transmitter2* >( kernel().node_manager.get_node(
...
Node*
STDPDopa2CommonProperties::get_node()
{
  if ( vt_ == 0 )
    throw BadProperty(
