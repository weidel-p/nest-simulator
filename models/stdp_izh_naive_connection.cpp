...
STDPIzhNaiveCommonProperties::STDPIzhNaiveCommonProperties()
...
void
STDPIzhNaiveConnection::time_driven_update( const thread tid, const double t_trig, const CommonPropertiesType& cp )
{
