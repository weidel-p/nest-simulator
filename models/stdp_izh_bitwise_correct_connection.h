...
#ifndef STDP_IZH_BITWISE_CORRECT_CONNECTION_H
#define STDP_IZH_BITWISE_CORRECT_CONNECTION_H
...
class STDPIzhBitwiseCorrectCommonProperties : public CommonSynapseProperties
{
public:
  /**
   * Default constructor.
   ...
   */
  STDPIzhBitwiseCorrectCommonProperties();
...
class STDPIzhBitwiseCorrectConnection : public Connection< TargetIdentifierPtrRport >
{

public:
  typedef STDPIzhBitwiseCorrectCommonProperties CommonPropertiesType;
   ...
   */
  STDPIzhBitwiseCorrectConnection();
   ...
   */
  STDPIzhBitwiseCorrectConnection( const STDPIzhBitwiseCorrectConnection& );
 ...
 */
inline void
STDPIzhBitwiseCorrectConnection::send( Event& e,
  thread tid,
  double,
  const CommonPropertiesType& )
{
...
#endif // of #ifndef STDP_IZH_BITWISE_CORRECT_CONNECTION_H
