...
nest.SetDefaults("state_separation_synapse", {"vt": vt[0], "A": 0.00001, "tau_short": 1000., "tau_long": 10000., "n_threshold": 10., "n": 10., "Wmax": 5., "weight": 2.5})
nest.Connect([n[0]], [n[1]], syn_spec={"model": "state_separation_synapse"})
